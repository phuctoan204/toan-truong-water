...
namespace WebBanHangOnline.Models.EF
{
    ...
    public class Product : CommonAbstract
    {
        ...
        public int? ProductTypeId { get; set; } // Cho phép NULL

        [ForeignKey("ProductTypeId")]
        public virtual ProductType ProductType { get; set; } // Quan hệ với ProductType
        ...
        public bool IsAdditionalFee { get; set; }  // Đánh dấu sản phẩm cần tính phí thêm
    }
}